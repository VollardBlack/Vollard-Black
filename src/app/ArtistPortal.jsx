...
export default function ArtistPortal(){
  ...
  const checkTermsLocal=(email)=>{try{const s=JSON.parse(localStorage.getItem('vb_terms_artist')||'null');return !!(s&&s.email===email&&s.v===TERMS_VERSION);}catch{return false;}};
