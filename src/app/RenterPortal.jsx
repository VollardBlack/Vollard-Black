        ...
        <div style={{...S.card, padding:32, boxShadow:'0 8px 32px rgba(0,0,0,0.06)'}}>
          ...
          <form onSubmit={handleRegister}>
            ...
            <div style={{marginBottom:20}}>
              ...
              <textarea value={form.message} onChange={e=>s('message',e.target.value)} style={{...S.input,minHeight:70,resize:'vertical'}} placeholder="Anything you'd like Vollard Black to know..."/>
            </div>
          ...
          <div style={{textAlign:'center',marginTop:16,fontSize:12,color:'#8a8070'}}>
            Already have access? <button onClick={()=>onRegistered(null)} style={{background:'none',border:'none',color:'#b68b2e',cursor:'pointer',fontSize:12,fontFamily:"'DM Sans',sans-serif",textDecoration:'underline'}}>Sign in</button>
          </div>
        </div>
