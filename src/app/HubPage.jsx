    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        html,body{height:100%;background:#f5f3ef;}
      ...
      <div style={{
        minHeight: '100vh',
        background: 'radial-gradient(ellipse at 15% 60%, rgba(182,139,46,0.08) 0%, transparent 55%), radial-gradient(ellipse at 85% 15%, rgba(100,140,200,0.04) 0%, transparent 50%), #f5f3ef',
        ...
        <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 1080 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 60, animation: mounted ? 'fadeUp 0.7s ease both' : 'none' }}>
            <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(42px,7vw,72px)', fontWeight: 300, letterSpacing: '0.22em', lineHeight: 1 }}>
              <span style={{ color: '#1a1714' }}>VOLLARD </span>
              <span className="logo-text">BLACK</span>
            </div>
            <div style={{ marginTop: 12, fontSize: 10, letterSpacing: '0.40em', textTransform: 'uppercase', color: 'rgba(26,23,20,0.40)' }}>
              Fine Art Acquisitions Platform
            </div>
            <div style={{ width: 56, height: 1, margin: '22px auto 0', background: 'linear-gradient(90deg, transparent, rgba(182,139,46,0.45), transparent)' }} />
          </div>
          ...
          <div style={{
            ...
            {portals.map((p, i) => (
              <a
                ...
                style={{
                  background: hovered === p.id ? '#ffffff' : 'rgba(255,255,255,0.80)',
                  border: `1px solid ${hovered === p.id ? p.border : 'rgba(182,139,46,0.18)'}`,
                  borderRadius: 14,
                  padding: '26px 22px 22px',
                  boxShadow: hovered === p.id ? `0 16px 48px rgba(0,0,0,0.12), 0 0 0 1px ${p.border}` : '0 2px 16px rgba(0,0,0,0.08)',
              ...
              >
                ...
                {/* Description */}
                <div style={{ fontSize: 12, color: 'rgba(26,23,20,0.50)', lineHeight: 1.75, minHeight: 54 }}>
                  {p.desc}
                </div>
          ...
          <div style={{
            ...
            color: 'rgba(26,23,20,0.35)', letterSpacing: '0.08em',
            ...
            <a href="/terms" style={{ color: 'rgba(182,139,46,0.65)', textDecoration: 'none' }}>Terms</a>
          </div>
        </div>
      </div>
    </>
