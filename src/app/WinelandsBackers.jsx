            ...
            {!selectedWork ? (
              ...
              <div style={{ border: `1px solid ${C.goldBorder}`, borderRadius: 6, background: C.inkMid, overflow: 'hidden' }}>
                ...
                <div style={{ position: 'relative', paddingBottom: '80%', overflow: 'hidden', background: C.ink }}>
                  <img
                    key={imgIdx}
                    src={selectedWork.images && selectedWork.images[imgIdx] ? selectedWork.images[imgIdx] : selectedWork.image}
                ...
                <div style={{ padding: '18px 20px' }}>
                  ...
                  {/* Variants if any */}
                  {selectedWork.variants && selectedWork.variants.length > 1 && (
